import '../best_product_one_screen/widgets/productcardgrid_item_widget.dart';
...
class BestProductOneScreen extends GetWidget<BestProductOneController> {
  const BestProductOneScreen({Key? key}) : super(key: key);
  ...
  /// Section Widget
  Widget _buildProductCardGrid() {
    return Align(
        alignment: Alignment.center,
        child: Padding(
            padding: EdgeInsets.only(left: 14.h, right: 1.h),
            child: Obx(() => GridView.builder(
                ...
                itemCount: controller.bestProductOneModelObj.value
                    .productcardgridItemList.value.length,
                itemBuilder: (context, index) {
                  ProductcardgridItemModel model = controller
                      .bestProductOneModelObj
                      .value
                      .productcardgridItemList
                      .value[index];
