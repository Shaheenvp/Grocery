...
class DeliverToCurrentLocationScreen
    extends GetWidget<DeliverToCurrentLocationController> {
  const DeliverToCurrentLocationScreen({Key? key}) : super(key: key);
    ...
    return Obx(() => Column(children: [
          Padding(
              ...
              child: CustomRadioButton(
                  ...
                  value: controller.deliverToCurrentLocationModelObj.value
                      .radioList.value[0],
