...
class DeliverToCurrentLocationOneScreen
    extends GetWidget<DeliverToCurrentLocationOneController> {
  const DeliverToCurrentLocationOneScreen({Key? key}) : super(key: key);
    ...
    return Obx(() => Column(children: [
          Padding(
              ...
              child: CustomRadioButton(
                  ...
                  value: controller.deliverToCurrentLocationOneModelObj.value
                      .radioList.value[0],
