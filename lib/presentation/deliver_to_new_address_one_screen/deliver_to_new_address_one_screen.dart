...
class DeliverToNewAddressOneScreen
    extends GetWidget<DeliverToNewAddressOneController> {
  const DeliverToNewAddressOneScreen({Key? key}) : super(key: key);
    ...
    return Obx(() => Column(children: [
          Padding(
              ...
              child: CustomRadioButton(
                  ...
                  value: controller
                      .deliverToNewAddressOneModelObj.value.radioList.value[0],
          ...
          Padding(
              ...
              child: CustomRadioButton(
                  ...
                  value: controller
                      .deliverToNewAddressOneModelObj.value.radioList.value[2],
                  groupValue: controller.radioGroup.value,
                  onChange: (value) {
                    controller.radioGroup.value = value;
                  }))
